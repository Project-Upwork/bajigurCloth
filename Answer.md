...
1. Proses saya dalam mengerjakan test ini , saya menggunakan dengan Python Django. Penambahan  feature pada system saya menambahkan:
 ...
 - Biarkan pembeli berpikir jernih, sehingga setelah membeli merasakan kepuasaan dan tentunya kembali lagi.
  ...
  Konsep dalam protype ini adalah masih monolitik, masih dalam rangkaian satu service, masih dalam satu database.

  Akan tetapi saya sudah attach konsep awal saya sebenernya adalah membangun system yang support bisnis. Saya cantumkan draw plan nya di [draw plan](./draw_plan.png).


2. Saya tidak memiliki tantangan pada masalah tehnis, tapi pada pelaksanaanya saja saya butuh waktu, dan memfocuskan ke konsep.
